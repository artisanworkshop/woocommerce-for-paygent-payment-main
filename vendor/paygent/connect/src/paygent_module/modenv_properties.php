...
### クライアント証明書ファイルパス ###
paygentB2Bmodule.client_file_path=/demo/

### Trusted Server Certificate ###
### 認証済みのCAファイルパス   ###
paygentB2Bmodule.ca_file_path=/demo/
...
paygentB2Bmodule.default_id=00
paygentB2Bmodule.default_password=00
...
### Program Log File     ###
### ログファイル出力パス ###
paygentB2Bmodule.log_output_path=/log/
...
###ネット口座振替受付URL###
paygentB2Bmodule.url.265=https://module.paygent.co.jp/n/accounttransfer/receipt
###楽天ペイURL###
...
###PayPayURL###
paygentB2Bmodule.url.42=https://module.paygent.co.jp/n/paypay/request
###PI基盤URL###
paygentB2Bmodule.url.41=https://module.paygent.co.jp/n/pi/request
###ときめきポイント決済URL###
paygentB2Bmodule.url.43=https://module.paygent.co.jp/n/tokimekiPoint/request
###3Dセキュア2.0認証URL###
paygentB2Bmodule.url.45=https://module.paygent.co.jp/n/threeds/request
###トークン取得URL###
paygentB2Bmodule.url.098=https://token.paygent.co.jp/n/token/request
?>