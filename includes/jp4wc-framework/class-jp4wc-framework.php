...
if ( ! class_exists( '\\ArtisanWorkshop\\PluginFramework\\v2_0_13\\JP4WC_Framework' ) ) :
	...
	class JP4WC_Framework {
		...
		public function jp4wc_support_notice( $support_form_url ) {
			...
			<p class="inner"><?php printf( wp_kses( $this->text_array['support_notice_02'], $this->allowed_html ), esc_html( $support_form_url ) . '?utm_source=jp4wc-settings&utm_medium=link&utm_campaign=top-support' ); ?></p>
			<p class="inner"><?php printf( wp_kses( $this->text_array['support_notice_03'], $this->allowed_html ), 'https://wc.artws.info/product-category/setting-support/?utm_source=jp4wc-settings&utm_medium=link&utm_campaign=setting-support', 'https://wc.artws.info/product-category/maintenance-support/?utm_source=jp4wc-settings&utm_medium=link&utm_campaign=maintenance-support' ); ?></p>
			<?php
		}
		...
		public function jp4wc_pro_notice( $jp4wc_pro_url ) {
			...
			<p class="inner"><?php printf( wp_kses( $this->text_array['pro_notice_02'], $this->allowed_html ), esc_url( $jp4wc_pro_url ) . '?utm_source=jp4wc-settings&utm_medium=link&utm_campaign=top-pro' ); ?></p>
